<template>
    <div id="v-buildinginfo">
        ...
        <p>{{b_type}}</p>
        <p>{{b_info}}</p>
        <p>{{b_address1}} {{b_address2}} {{b_address3}} </p>
    </div>
</template>
        ...
        buildingObject: {
            ...
            default: function () {
                return { 
                    ...
                    building_image: 'https://images.pexels.com/photos/1092063/pexels-photo-1092063.jpeg?auto=compress&cs=tinysrgb&h=750&w=1260',
